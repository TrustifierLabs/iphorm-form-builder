<?php if (!defined('IPHORM_VERSION')) exit; ?><table class="widefat">
    ...
    <?php foreach ($forms as $form) : ?>
        ...
        <tr>
            ...
            <td class="iphorm-db-widget-link"><a class="ifb-button" href="<?php echo admin_url('admin.php?page=iphorm_entries&amp;id=' . $config['id']); ?>"><?php esc_html_e('View entries', 'iphorm'); ?></a></td>
        </tr>
    <?php endforeach; ?>
</table>