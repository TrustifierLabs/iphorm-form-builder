	...
	<div class="ifb-top-element-wrap qfb-cf">
        ...
        <div class="ifb-element-preview ifb-element-preview-email">
            ...
            <div class="ifb-preview-input">
                <input type="email" name="ifb_element_<?php echo $id; ?>" id="ifb_element_<?php echo $id; ?>" value="<?php echo esc_attr($element['default_value']); ?>" disabled="disabled"<?php echo $element['placeholder'] !== '' ? ' placeholder="' . iphorm_escape($element['placeholder']) . '"' : ''; ?> />
